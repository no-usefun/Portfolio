      ...
      <div className="relative mt-12 max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-16 items-center px-6">
        ...
        <div>
          ...
          <div className="mt-8 flex gap-4">
            <Button
              className="bg-blue-600 text-white border-none transition-all duration-300 ease-out hover:-translate-y-1 
                        hover:shadow-lg hover:shadow-blue-500/30 hover:bg-blue-500 active:scale-95"
              variant="outline"
              onClick={openResume}
            >
              View Resume
